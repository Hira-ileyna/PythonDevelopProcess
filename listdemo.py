...
arabalar[-1] = 'Toyota'
result = arabalar
# 5- Mercedes listenin bir elemanımı mıdır?
...
result = arabalar[:3]
result = arabalar[-2:]
# 8- Listenin son iki elemanı yerine "Toyota" ve "Renualt" değerlerini ekleyin.
arabalar[-2:] = ['Toyota' , 'Renault']
result = arabalar
# 9- Listenin üstüne "Audi" ve "Nissan" değerlerini ekleyin.
...
studentA = ['Yiğit','Bilgi',2010,[70,60,70]]
studentB = ['Sena','Turan',1999,[80,80,71]]
studentC = ['Ahmet','Turan',1998,[80,70,90]]
